...
class ExpeditionResource extends Resource
{
    ...
    {
        return auth()->user()?->can('view_expeditions') ?? false;
    }

    public static function canCreate(): bool
    {
        return auth()->user()?->can('create_expeditions') ?? false;
    }

    public static function canEdit(Model $record): bool
    {
        return auth()->user()?->can('update_expeditions') ?? false;
    }

    public static function canDelete(Model $record): bool
    {
        return auth()->user()?->can('delete_expeditions') ?? false;
    }
