...
class TaskTerimaSupplierResource extends Resource
{
    ...
    {
        return auth()->user()?->can('view_task_terima_suppliers') ?? false;
    }

    public static function canCreate(): bool
    {
        return auth()->user()?->can('create_task_terima_suppliers') ?? false;
    }

    public static function canEdit(Model $record): bool
    {
        return auth()->user()?->can('update_task_terima_suppliers') ?? false;
    }

    public static function canDelete(Model $record): bool
    {
        return auth()->user()?->can('delete_task_terima_suppliers') ?? false;
    }
